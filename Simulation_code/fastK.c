...
#define nrn_init _nrn_init__fastK
#define _nrn_initial _nrn_initial__fastK
#define nrn_cur _nrn_cur__fastK
#define _nrn_current _nrn_current__fastK
#define nrn_jacob _nrn_jacob__fastK
#define nrn_state _nrn_state__fastK
#define _net_receive _net_receive__fastK 
#define evaluate_fct evaluate_fct__fastK 
#define states states__fastK 
...
#define gflut _p[1]
#define gflut_columnindex 1
#define eflut _p[2]
#define eflut_columnindex 2
#define iflut _p[3]
#define iflut_columnindex 3
#define n_inf _p[4]
#define n_inf_columnindex 4
#define tau_n _p[5]
#define tau_n_columnindex 5
#define n _p[6]
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_fastK", _hoc_setdata,
 "evaluate_fct_fastK", _hoc_evaluate_fct,
 "vtrap0_fastK", _hoc_vtrap0,
 "vtrap_fastK", _hoc_vtrap,
 0, 0
};
#define vtrap0 vtrap0_fastK
#define vtrap vtrap_fastK
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 fastK fastK.mod\n");
...
static int  evaluate_fct ( _threadargsprotocomma_ double _lv ) {
   double _la , _lb ;
 _la = vtrap ( _threadargscomma_ _lv ) ;
   _lb = vtrap0 ( _threadargscomma_ _lv ) ;
   tau_n = 1.0 / ( _la + _lb ) ;
   n_inf = _la / ( _la + _lb ) ;
    return 0; }
...
double vtrap ( _threadargsprotocomma_ double _lx ) {
   double _lvtrap;
 if ( fabs ( ( _lx + 83.2 ) / 1.1 ) < 1e-6 ) {
     _lvtrap = 0.0462 * 1.1 ;
     }
   else {
     _lvtrap = ( 0.0462 * ( _lx + 83.2 ) ) / ( 1.0 - exp ( - ( _lx + 83.2 ) / 1.1 ) ) ;
     }
...
double vtrap0 ( _threadargsprotocomma_ double _lx ) {
   double _lvtrap0;
 if ( fabs ( ( _lx + 66.0 ) / 10.5 ) < 1e-6 ) {
     _lvtrap0 = 0.0824 * 10.5 ;
     }
   else {
     _lvtrap0 = ( 0.0824 * ( - ( _lx + 66.0 ) ) ) / ( 1.0 - exp ( ( _lx + 66.0 ) / 10.5 ) ) ;
     }
...
#if NMODL_TEXT
static const char* nmodl_filename = "fastK.mod";
static const char* nmodl_file_text = 
