...
#define nrn_init _nrn_init__kdifrl
#define _nrn_initial _nrn_initial__kdifrl
#define nrn_cur _nrn_cur__kdifrl
#define _nrn_current _nrn_current__kdifrl
#define nrn_jacob _nrn_jacob__kdifrl
#define nrn_state _nrn_state__kdifrl
#define _net_receive _net_receive__kdifrl 
#define conc conc__kdifrl 
...
#define dt _nt->_dt
#define Dk _p[0]
#define Dk_columnindex 0
#define ik _p[1]
#define ik_columnindex 1
#define ko _p[2]
#define ko_columnindex 2
#define Dko _p[3]
#define Dko_columnindex 3
#define v _p[4]
...
#define _gth 2
#define crossSectionalArea_kdifrl _thread1data[0]
#define crossSectionalArea _thread[_gth]._pval[0]
#define extracellularVolumePerLength_kdifrl _thread1data[1]
#define extracellularVolumePerLength _thread[_gth]._pval[1]
#define kbath kbath_kdifrl
 double kbath = 3;
#define kbathVolumePerLength kbathVolumePerLength_kdifrl
 double kbathVolumePerLength = 1e+15;
#define nodalGap nodalGap_kdifrl
 double nodalGap = 1.9;
#define radialRateConstant_kdifrl _thread1data[2]
#define radialRateConstant _thread[_gth]._pval[2]
#define radialCrosssectionalAreaPerLength_kdifrl _thread1data[3]
...
#define rn rn_kdifrl
 ...
 "nodalGap_kdifrl", "um",
 "rn_kdifrl", "um",
 "extracellularVolumePerLength_kdifrl", "um2",
 "crossSectionalArea_kdifrl", "um2",
 "kbathVolumePerLength_kdifrl", "um2",
 "radialCrosssectionalAreaPerLength_kdifrl", "um",
 "radialRateConstant_kdifrl", "um2/ms",
 "kbath_kdifrl", "mM",
 "Dk_kdifrl", "um2/ms",
 0,0
};
 ...
 "nodalGap_kdifrl", &nodalGap_kdifrl,
 "rn_kdifrl", &rn_kdifrl,
 "extracellularVolumePerLength_kdifrl", &extracellularVolumePerLength_kdifrl,
 "crossSectionalArea_kdifrl", &crossSectionalArea_kdifrl,
 "kbathVolumePerLength_kdifrl", &kbathVolumePerLength_kdifrl,
 "radialCrosssectionalAreaPerLength_kdifrl", &radialCrosssectionalAreaPerLength_kdifrl,
 "radialRateConstant_kdifrl", &radialRateConstant_kdifrl,
 "kbath_kdifrl", &kbath_kdifrl,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 kdifrl kdifrl.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "kdifrl.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
