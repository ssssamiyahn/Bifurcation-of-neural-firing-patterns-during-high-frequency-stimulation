...
#define nrn_init _nrn_init__calvrec
#define _nrn_initial _nrn_initial__calvrec
#define nrn_cur _nrn_cur__calvrec
#define _nrn_current _nrn_current__calvrec
#define nrn_jacob _nrn_jacob__calvrec
#define nrn_state _nrn_state__calvrec
#define _net_receive _net_receive__calvrec 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "rx_rec_calvrec", "megohm",
 "x_calvrec", "1",
 "y_calvrec", "1",
 "z_calvrec", "1",
 "er_calvrec", "microvolts",
 "im_calvrec", "milliamp/cm2",
 0,0
};
 static double v = 0;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "area");
 	...
 	ivoc_help("help ?1 calvrec calvrec.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "calvrec.mod";
static const char* nmodl_file_text = 
  "NEURON {\n"
  "	SUFFIX calvrec\n"
  "  RANGE rx_rec, er\n"
