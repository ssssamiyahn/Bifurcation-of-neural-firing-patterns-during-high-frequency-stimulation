...
#define nrn_init _nrn_init__kms
#define _nrn_initial _nrn_initial__kms
#define nrn_cur _nrn_cur__kms
#define _nrn_current _nrn_current__kms
#define nrn_jacob _nrn_jacob__kms
#define nrn_state _nrn_state__kms
#define _net_receive _net_receive__kms 
#define _f_trates _f_trates__kms 
#define rates rates__kms 
#define states states__kms 
#define trates trates__kms 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_kms", _hoc_setdata,
 "rates_kms", _hoc_rates,
 "states_kms", _hoc_states,
 "trates_kms", _hoc_trates,
 0, 0
};
...
#define tha tha_kms
 double tha = -30;
#define tadj tadj_kms
 double tadj = 0;
#define temp temp_kms
 double temp = 23;
#define usetable usetable_kms
 double usetable = 1;
#define vmax vmax_kms
 double vmax = 100;
#define vmin vmin_kms
 double vmin = -120;
...
static int _ode_count(int _type){ hoc_execerror("kms", "cannot be used with CVODE"); return 0;}
 ...
 v=_v;
{
  ek = _ion_ek;
 { error =  states();
 if(error){fprintf(stderr,"at line 72 in file kms.mod:\n        SOLVE states\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "kms.mod";
static const char* nmodl_file_text = 
  "\n"
  "COMMENT\n"
  "\n"
