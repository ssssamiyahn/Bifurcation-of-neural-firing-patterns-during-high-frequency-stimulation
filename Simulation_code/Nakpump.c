...
#define dt _nt->_dt
#define INaKmax _p[0]
#define INaKmax_columnindex 0
#define Kmnai _p[1]
#define Kmnai_columnindex 1
#define Kmko _p[2]
#define Kmko_columnindex 2
#define ik _p[3]
#define ik_columnindex 3
#define ina _p[4]
#define ina_columnindex 4
#define ink _p[5]
#define ink_columnindex 5
#define ko _p[6]
#define ko_columnindex 6
#define v _p[7]
...
#define dummy dummy_NaKpump
 double dummy = 0;
#define nai nai_NaKpump
 double nai = 10;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "INaKmax_NaKpump", 0, 1e+06,
 "Kmnai_NaKpump", 0, 1e+06,
 "Kmko_NaKpump", 0, 1e+06,
 0,0,0
};
 ...
 "nai_NaKpump", &nai_NaKpump,
 "dummy_NaKpump", &dummy_NaKpump,
 0,0
};
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
 ...
 _lq10 = pow( 3.0 , ( ( celsius - 37.0 ) / 10.0 ) ) ;
   ...
   ink = _lq10 * INaKmax * _lfnk / ( ( 1.0 + pow( ( Kmnai / nai ) , 1.5 ) ) * ( 1.0 + Kmko / ko ) ) ;
   ina = 3.0 * ink ;
   ik = - 2.0 * ink ;
   }
 _current += ik;
